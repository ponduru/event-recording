"""Warehouse-specific detector model."""
...
class WarehouseDetector(BaseEventDetector):
    """Warehouse event detection model.

    Optimized for surveillance footage and warehouse operational events.
    """
    ...
    def __init__(
        ...
        """Initialize the warehouse detector.
