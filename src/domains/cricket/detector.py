"""Cricket-specific detector model.

This module contains the cricket delivery detection model, which is a
domain-specific implementation of the base event detector.
"""
...
class CricketDetector(BaseEventDetector):
    """Cricket delivery detection model.

    Combines CNN frame encoder with LSTM temporal modeling
    for binary classification of video windows containing deliveries.
    """
    ...
    def __init__(
        ...
        """Initialize the cricket detector.
